...
<html>
    <head>
        ...
        <body style="margin: 1% 10%">
            ...
            <div align="center">
                ...
                <form action="timetable" method="GET" onsubmit="return validate();" id="form">
                    <input type="hidden" name="lid" value="${param.lid}"/>
                    From: <input type="date" name="from" value="${requestScope.from}" id="from"/> 
                    To: <input type="date" name="to" value="${requestScope.to}" id="to"/>
    ...
    <script language="JavaScript">
        ...
        var to = document.getElementById('to').value;
                if (from > to){
        alert("from bigger than to! Please re-enter!");
                return false;
        } else{
        return true; }
        }
